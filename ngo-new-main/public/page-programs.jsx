        ...
        <div className="rg-split" style={{ marginTop: "clamp(36px,4vw,52px)", alignItems: "start" }}>
          ...
          <div className="card" style={{ padding: "30px 28px", background: "var(--cream-soft)" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
              <a href="donate.html" className="btn btn-primary"><Icon name="heart" size={17} /> Donate to this program</a>
              <a href="volunteer.html" className="btn btn-ghost">Volunteer</a>
            </div>
          </div>
        </div>
      </div>
...
function ProgramsPage() {
  return (
    <>
      ...
      <PageHero
        trail={[["Home", "RG Care Foundation.html"], ["Programs"]]}
        eyebrow="What we do"
        ...
        actions={<>
          <a href="donate.html" className="btn btn-primary btn-lg"><Icon name="heart" size={18} /> Donate now</a>
          <a href="csr.html" className="btn btn-ghost btn-lg">Partner with us</a>
        </>}
      />
