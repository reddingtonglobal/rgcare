...
function AboutPage() {
  ...
  return (
    <>
      ...
      <PageHero
        trail={[["Home", "RG Care Foundation.html"], ["About"]]}
        eyebrow="About us"
        ...
        actions={<>
          <a href="donate.html" className="btn btn-primary btn-lg"><Icon name="heart" size={18} /> Support our work</a>
          <a href="transparency.html" className="btn btn-ghost btn-lg">See our governance</a>
        </>}
      />
      ...
      <section className="section rg-band-cream">
        <div className="wrap wrap-wide rg-split">
          <div>
            ...
            <a href="transparency.html" className="rg-textlink">View transparency & reports <Icon name="arrow-right" size={16} /></a>
          </div>
          <div className="rg-feature-media">
